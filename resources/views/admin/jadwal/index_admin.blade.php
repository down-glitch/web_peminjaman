                ...
                <div class="schedule-list">
                    ...
                    <div class="schedule-card">
                        ...
                        <div class="schedule-actions">
                            <a href="{{ route('jadwal.edit', $j->id_reguler) }}" class="btn-edit" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('jadwal.destroy', $j->id_reguler) }}" method="POST">
                                @csrf @method('DELETE')
                                <button type="submit" class="btn-delete" title="Hapus" onclick="return confirm('Hapus jadwal ini?')">
